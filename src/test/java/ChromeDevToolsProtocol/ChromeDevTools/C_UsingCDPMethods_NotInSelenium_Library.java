 ...
 */
		...
		driver.executeCdpCommand("Emulation.setDeviceMetricsOverride",setDeviceMetricsOverrideCustom(1000,600,50,true)); 
	...
	public static Map<String, Object> setDeviceMetricsOverrideCustom(Integer width, Integer height, Integer deviceScaleFactor, boolean mobile)
	{
